...
You are encouraged to read the **User Manual** and **Technical Documentation** for the Tool (both located in the _Documentation_ directory). These may also be accessed (along with other information) in the "About" tab of the Tool interface.
