...
*  Tool interface: <https://bstaton.shinyapps.io/BayesTool/>
*  Tool user manual: [**INSERT LINK**]
*  Tool technical documentation (this document): [**INSERT LINK**]
*  Source code for the Tool and all documentation: <https://github.com/bstaton1/kusko-bayes-tool>
