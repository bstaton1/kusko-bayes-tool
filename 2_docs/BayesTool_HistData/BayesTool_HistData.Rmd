...
kable(tab, "latex", booktabs = T,
      caption = "Pre-season run size forecast expectation (mean) and uncertainty (coefficient of variation; CV). Run size data are from \\cite{smith-2019}.",
...
kable(tab, "latex", booktabs = T,
  ...
  footnote(title_format = c("bold", "underline"),
    ...
    alphabet = c(
      "Most current run size estimates used; presented in \\\\cite{smith-2019}"
    ),
    number = c(
