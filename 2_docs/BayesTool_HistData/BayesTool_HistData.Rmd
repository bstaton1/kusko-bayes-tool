...
kable(tab, "latex", booktabs = T,
      caption = "Pre-season run size forecast expectation (mean) and uncertainty (coefficient of variation; CV). Run size data are from \\cite{larson-2022}.",
...
kable(tab, "latex", booktabs = T,
  ...
  footnote(title_format = c("bold", "underline"),
    ...
    alphabet = c(
      "Most current run size estimates used; presented in \\\\cite{larson-2022}"
    ),
    number = c(
